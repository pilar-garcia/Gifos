...
const displayBurgerMenu = () => {
	if (localStorage.getItem('dark-mode') === 'true') {
		if ($navbarList.classList.contains('hiddenMenu')) {
			...
			$burgerMenu.src = 'resources/assets/close-modo-noct.svg';
		} else {
		...
		if ($navbarList.classList.contains('hiddenMenu')) {
			$navbarList.classList.remove('hiddenMenu');
			$burgerMenu.src = 'resources/assets/close.svg';
		} else {
			$navbarList.classList.add('hiddenMenu');
			$burgerMenu.src = 'resources/assets/burger.svg';
		}
	}
};
...
$crearGifBtn.addEventListener('click', () => {
	$crearGifBtn.src = 'resources/assets/CTA-crear-gifo-active.svg';
});

$crearGifBtn.addEventListener('mouseover', () => {
	$crearGifBtn.src = 'resources/assets/CTA-crear-gifo-hover.svg';
});

$crearGifBtn.addEventListener('mouseout', () => {
	$crearGifBtn.src = 'resources/assets/button-crear-gifo.svg';
});
